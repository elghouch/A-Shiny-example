...
**How to use**: choose a number, say $b$ using the box below labled "Choose a number". Once done, $100$ random observations from $N(b,1)$ will be generated, and you get:
